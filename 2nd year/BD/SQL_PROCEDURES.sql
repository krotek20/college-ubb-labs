...
as
exec uspChangeColumnType 'AGE', 'bigint', 'CLIENT'
go

create proc uspSetDbVersion2
as
exec uspSetColumnDefaultValue 'AGE', '18', 'CLIENT'
go
...
as
exec uspAddColumn 'COL', 'int', 'TEST'
go

create proc uspSetDbVersion5
as
exec uspAddForeignKey 'COL', 'TEST', 'ID', 'CITY'
go
...
exec uspSetDbPredefinedVersion 3
