...
url = "https://funny-photo.s3.amazonaws.com/preview/vintage_sepia_effect/view-over-tallinn-with-sepia-filter.jpg"
path = tf.keras.utils.get_file('file5', origin=url)
