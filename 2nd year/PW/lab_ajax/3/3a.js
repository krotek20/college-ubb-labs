...
function fillForm(idElement) {
    ...
    // functie de id-ul pe care s-a dat click, altfel intrebam daca
    // se doreste salvarea datelor modificate.
    if (changesMade && confirm("Exista schimbari nesalvate! Doriti sa le salvati?")) {
        saveChanges();
    }
    ...
    // iar acum nu mai sunt schimbari
    changesMade = false;
    document.getElementById("saveButton").disabled = true;
}
